...
class Ui_HDF5VideoPlayer(object):
    def setupUi(self, HDF5VideoPlayer):
        ...
        HDF5VideoPlayer.resize(660, 744)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 632, 444))
        ...
        self.spinBox_int_low = QtWidgets.QSpinBox(self.centralWidget)
        ...
        self.spinBox_int_high = QtWidgets.QSpinBox(self.centralWidget)
        self.spinBox_int_high.setObjectName("spinBox_int_high")
        self.gridLayout_4.addWidget(self.spinBox_int_high, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.horizontalSlider_int_high, 1, 1, 1, 1)
